...
const deriveKey = async () => {
  ...
  try {
    const response = await connector.signMessage({
      message:
        "DO NOT EVER SIGN THIS TEXT WITH YOUR PRIVATE KEYS! IT IS ONLY USED FOR DERIVATION OF LIQUID KEY PAIRS, DISCLOSING THIS SIGNATURE WILL COMPROMISE YOUR LIQUID IDENTITY!",
      key_loc: {
        key_family: 0,
        key_index: 0,
      },
